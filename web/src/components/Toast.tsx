...
export const GlobalToastProvider: FunctionComponent<Props> = ({ children }) => {
	...
	return (
		<ToastContext.Provider value={setToast}>
			...
			<div id="toast-default" className={`flex select-none animate-bounce pointer-events-none transition-opacity duration-300 fixed bottom-0 right-0 items-center p-4 m-6 text-gray-500 bg-[black] rounded-lg ${!!toast ? 'opacity-100' : 'opacity-0'}`} role="alert">
